    ...
    <div className="col-span-3 bg-white rounded-lg p-8">
      ...
      <div className="grid grid-cols-6 gap-12">
        ...
        <div className="col-span-6 lg:col-span-2">
          ...
          <div className="text-center text-xs">Auto Reset in Sekunden</div>
        </div>
        <div className="col-span-6 lg:col-span-2">
          <div className="form-control w-52">
            <label className="cursor-pointer label">
        ...
        <div className="col-span-6 lg:col-span-2">
          <div className="form-control w-52">
            <label className="cursor-pointer label">
              <span
                className="label-text tooltip"
                data-tip="Countdown auf Wertungsbildschirm ein- / ausblenden"
              >
                Timer ausblenden
              </span>
              <input
        ...
        <div className="col-span-6 lg:col-span-2">
          <div className="form-control w-52">
            <label className="cursor-pointer label">
              <span
                className="label-text tooltip"
                data-tip="Athleten / Versuche aus dem Vereinsportal abrufen / anzeigen"
              >
                VPortal Daten abrufen
              </span>
              <input
                type="checkbox"
                name={"getVportalData"}
        ...
        <div className="col-span-6 lg:col-span-2">
          <div className="form-control w-52">
            <label className="cursor-pointer label">
              <span
                className="label-text tooltip"
                data-tip="Kampfrichter-Wertung automatisch an Vereinsportal senden"
              >
                Wertung senden
              </span>
              <input
