...
import type { RatingObject, SettingsObject, RefObject } from "../types/types";
            ...
            <div className=" space-y-4">
              <div className="w-full mb-14 mt-1">
                <RefButton
                  color={"white"}
                  title={"Weiß"}
                  url={`${import.meta.env.VITE_BASE_URL}/api/ref/?token=${token}&light=white`}
                  method={"GET"}
                />
              </div>
              <div className="w-full">
                <RefButton
                  color={"red"}
                  title={"Rot"}
                  url={`${import.meta.env.VITE_BASE_URL}/api/ref/?token=${token}&light=red`}
                  method={"GET"}
                />
              </div>
              <div className="w-full">
                <RefButton
                  color={"blue"}
                  title={"Blau"}
                  url={`${import.meta.env.VITE_BASE_URL}/api/ref/?token=${token}&light=blue`}
                  method={"GET"}
                />
              </div>
              <div className="w-full">
                <RefButton
                  color={"yellow"}
                  title={"Gelb"}
                  url={`${import.meta.env.VITE_BASE_URL}/api/ref/?token=${token}&light=yellow`}
                  method={"GET"}
                />
              </div>
            </div>
              ...
              <div className="flex flex-row w-full space-x-6">
                <div className="w-full flex-grow">
                  <RefButton
                    color={"gray"}
                    title={"Start"}
                    url={`${import.meta.env.VITE_BASE_URL}/api/timer?token=${token}&position=main`}
                    method={"POST"}
                  />
                </div>
                <div className="w-full ">
                  <RefButton
                    color={"gray"}
                    title={"Reset"}
                    url={`${import.meta.env.VITE_BASE_URL}/api/ref/reset?token=${token}&position=main`}
                    method={"POST"}
                  />
                </div>
              </div>
