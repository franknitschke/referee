  ...
  return (
    <>
      {!competitionData || competitionData?.length === 0 ? (
        <div className='h-screen w-full flex items-center justify-center bg-black text-white text-4xl'><div className='w-10/12 text-white'><Alert msg={'Keine Daten vorhanden!'} /></div></div>
      ) : (
