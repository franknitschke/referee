...
import type { RatingObject } from '../types/types';
    ...
    return (
        <>
          ...
          <div className='flex flex-col w-11/12 m-auto items-center py-6 gap-6'>
            ...
            <div className=' w-10/12'>
              <RefButton color='white' title='Start' url={`${import.meta.env.VITE_BASE_URL}/api/timer?token=${token}&position=timekeeper`} method='POST'/>
            </div>
            <div className=' w-10/12'>
              <RefButton color='red' title='Reset' url={`${import.meta.env.VITE_BASE_URL}/api/ref/reset?token=${token}&position=timekeeper`} method='POST'/>
            </div>
